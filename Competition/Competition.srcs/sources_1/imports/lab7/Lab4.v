...
module Lab4(Clk, Rst, x_out, y_out, s1, writeDataReg, pc_out);
    ...
    wire [1:0] RSBranchSelectWire, RTBranchSelectWire;
    wire [31:0] instruction_ID, PC_ID, jumpTarget, control_in;
    wire signed [31:0] sl2_out, signExt_out, regData1_ID, regData2_ID, RSBranchSelectOut, RTBranchSelectOut, saExt_ID;
    ...
    wire signed [31:0] ALUResult_EX, rsSelOut_EX, rtSelOut_EX;
    wire [31:0] PC_EX, instruction_EX;
    wire [5:0] ALUControl_in;
    wire [4:0] rt_sel_EX, rs_sel_EX, rd_sel_EX, writeReg_sel_EX;
    wire [3:0] ALUOp_EX, ALUControl_out;
    wire [1:0] storeMemSrc_EX, loadMemSrc_EX, rsSel_EX_signal, rtSel_EX_signal;
...
//    InstructionMemory IM(pc_out, instruction_IF);
    ...
    Mux3to1 RsBranchSelect(RSBranchSelectOut, regData1_ID, ALUResult_EX, ALUResult_MEM, RSBranchSelectWire);
    Mux3to1 RtBranchSelect(RTBranchSelectOut, regData2_ID, ALUResult_EX, ALUResult_MEM, RTBranchSelectWire);
    Branch branch(BranchSrc_ID, RSBranchSelectOut, RTBranchSelectOut, PCSrc);
    Mux1Bit2To1 RegWriteMux(RegWrite, RegWrite_WB, 1'b1, RegWriteSrc);
    
    //Frowarding
    Forwarding_ID ID_Forwarding(instruction_ID, rs_sel, rt_sel, writeReg_sel_EX, RegWrite_EX, writeReg_sel_MEM, RegWrite_MEM, RSBranchSelectWire, RTBranchSelectWire);
    
    // Hazarding
    Hazard hazard(rs_sel, rt_sel, RegWrite_EX, writeReg_sel_EX, MemRead_EX,
        RegWrite_MEM, writeReg_sel_MEM, MemRead_MEM,
    ...
    RegisterFile Registers(s1, x_out, y_out, rs_sel, rt_sel, writeReg_sel, writeDataReg, RegWrite, Clk, regData1_ID, regData2_ID);
    ...
    assign rs_sel_EX = instruction_EX[25:21];
    ...
    ID_EX_Register ID_EX_reg(PCSrc, Rst, Clk, regData1_ID, regData2_ID, signExt_out, rt_sel, rd_sel, saExt_ID, 
        ...
        instruction_ID, instruction_EX
        );
    
    Mux3to1 rsMux_EX(rsSelOut_EX, regData1_EX, ALUResult_MEM, almostWriteDataReg, rsSel_EX_signal);
    Mux3to1 rtMux_EX(rtSelOut_EX, regData2_EX, ALUResult_MEM, almostWriteDataReg, rtSel_EX_signal);
    Forwarding_EX EX_Forwarding(instruction_EX, rs_sel_EX, rt_sel_EX, writeReg_sel_MEM, RegWrite_MEM, 
        writeRegMuxIn_0, RegWrite_WB, rsSel_EX_signal, rtSel_EX_signal);
    
    Mux32Bit2To1 signExtMux(ALUInput1, rsSelOut_EX, sa_EX, shiftSrc_EX);
    Mux32Bit2To1 ALUMux(ALUInput2, rtSelOut_EX, signExtImm_EX, ALUSrc_EX);
    ...
    memSelector storeSel(rtSelOut_EX, writeMemData_EX, storeMemSrc_EX);
